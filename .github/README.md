...
[`@aws-sdk/client-sagemaker-runtime-http2`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-runtime-http2/v/3.1113.0).
...
- @aws-sdk/client-sagemaker-runtime-http2 v3.1113.0 - [https://cloud-sdk-builds.github.io/?sdk=client-sagemaker-runtime-http2&version=3.1113.0](https://cloud-sdk-builds.github.io/?sdk=client-sagemaker-runtime-http2&version=3.1113.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime-http2@3.1113.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GrnURohZwru5leHXK9AS0nFepOVJGhAwz7S38Y8+5+5fjZjq+ydtZnunKdKPrIBZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-runtime-http2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime-http2@3.1113.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime-http2@3.1113.0/index.min.mjs": "sha384-GrnURohZwru5leHXK9AS0nFepOVJGhAwz7S38Y8+5+5fjZjq+ydtZnunKdKPrIBZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-runtime-http2/blob/refs/tags/3.1113.0/LICENSE
```
