...
[`@aws-sdk/client-sagemaker-runtime-http2`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-runtime-http2/v/3.1042.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime-http2@3.1042.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mBXyQUCeSNY3TGvi3YnWk8eme4P6eqFnVZ8ORwOaqIBUmClqAd30+5UQE5Wm7lMy
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-runtime-http2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime-http2@3.1042.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-runtime-http2@3.1042.0/index.min.mjs": "sha384-mBXyQUCeSNY3TGvi3YnWk8eme4P6eqFnVZ8ORwOaqIBUmClqAd30+5UQE5Wm7lMy"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-runtime-http2/blob/refs/tags/3.1042.0/LICENSE
```
